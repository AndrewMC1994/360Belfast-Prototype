...
AFRAME.registerComponent('dialog-popup', {
  ...
  /**
   * Generates the image2 entity.
   */
  generateImage2: function generateImage2() {
    var _this$data5 = this.data,
        src = _this$data5.image2,
        width = _this$data5.image2Width,
        height = _this$data5.image2Height,
        dialogBoxHeight = _this$data5.dialogBoxHeight;
    ...
    var image = this.image2El || document.createElement('a-image');
    image.setAttribute('id', "".concat(this.el.getAttribute('id'), "--image2"));
    image.setAttribute('src', src);
    image.setAttribute('width', width);
    image.setAttribute('height', height);
    image.setAttribute('position', {
  ...
  /**
   * Generates the infoimage entity.
   */
  generateImage2: function generateImage2() {
    var _this$data5 = this.data,
        src = _this$data5.image2,
  ...
  generateDialogPlane: function generateDialogPlane() {
    ...
    plane.appendChild(this.generateImage2());
    }
